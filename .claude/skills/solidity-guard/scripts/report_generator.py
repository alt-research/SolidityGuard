...
@page {
    ...
    @bottom-center {
        content: "Generated by SolidityGuard -- AI-Powered Solidity Security Audit Agent";
        font-size: 8pt;
        color: #6b7280;
...
symbolic execution (Mythril), and AI-powered manual review covering 80 vulnerability
...
- Manual AI-powered review (80 vulnerability patterns)

### Methodology
1. **Automated Static Analysis** — Slither (90+ detectors) and Aderyn (100+ detectors)
2. **Pattern Matching** — 80 vulnerability patterns (ETH-001 to ETH-080)
...
This report was generated by SolidityGuard, an AI-powered automated security analysis tool
...
By using SolidityGuard, you agree to our [Terms of Service](https://solidityguard.org/terms)
and [Privacy Policy](https://solidityguard.org/privacy).

For a professional manual audit, contact: **maintainers@altresear.ch**
Website: [solidityguard.org](https://solidityguard.org)

---

*Generated by SolidityGuard — AI-Powered Solidity Security Audit Agent*
"""
...
def _build_html(data: dict, project: str = "", client: str = "") -> str:
    ...
    <div class="cover-page">
        ...
        <div class="cover-subtitle">AI-POWERED SMART CONTRACT SECURITY AUDIT</div>
    ...
    <div class="section-break">
        ...
        AI-powered manual review covering 104 vulnerability patterns mapped to
    ...
    <div class="section-break">
        ...
        <h3>Tools Used</h3>
        <ul>{tools_list}
            <li>Manual AI-powered review (104 vulnerability patterns)</li>
        </ul>
...
Final Score: {score}/100</code></pre>
    ...
    <div class="section-break">
        <h1>7. Disclaimer</h1>
        <p>This report was generated by SolidityGuard, an AI-powered automated security analysis
        ...
        <p>By using SolidityGuard, you agree to our
        <a href="https://solidityguard.org/terms">Terms of Service</a> and
        <a href="https://solidityguard.org/privacy">Privacy Policy</a>.</p>

        <p>For a professional manual audit, contact: <strong>maintainers@altresear.ch</strong><br>
        Website: solidityguard.org</p>
    </div>

    <div class="footer-text">
        Generated by SolidityGuard &mdash; AI-Powered Solidity Security Audit Agent
    </div>
    """
